            ...
            <Col>
              <div className="movie-backdrop">
                ...
                <div className="movie-backdrop-image">
                  {movie.backdrop_path && <img  src={"https://image.tmdb.org/t/p/original"+movie.backdrop_path} alt="PeGu TV"/>}
                  {movie.backdrop_path==null && <img src={defaultBackdrop} alt="PeGu TV"/> }
                </div>
              </div>
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col md={3}>
              <div className="movie-poster">
                <img src={"https://image.tmdb.org/t/p/original"+movie.poster_path} alt="PeGu TV"/>
              </div>
            </Col>
          </Row>
          <br/>
