...
import logo from  '../assets/images/logopegutv.png'
import {FaInstagram, FaGithub, FaLinkedin, FaEnvelope, FaUser, FaQuestion, FaGlobe, FaWhatsapp, FaTelegram} from 'react-icons/fa'
      ...
      <section>
          ...
          <Row noGutters>
            <Col>
              <div className="hero-img">
                <img className="" src={Hero} alt="PeGu Tv"/>
                <h2>PeGu TV</h2>
              </div>
            </Col>
          </Row>
        ...
        <Container>
          <Row>
            <Col>
              <div className="det">
                <h1 className="highlight">About PeGu Tv</h1>
                <br/>
                <p>
                  PeGu Tv is a movie and show finder app where you can find movies, series, seasons,
                  ...
                  you can also find season and movie ratings to make a solid decision on what to watch next.PeGu TV gives you
                  flexibility and control to customize your home screen with your own card categories.
                </p>
                <br/>
              <p className="traptv-logo tmdb-logo2"><img className="" src={logo} alt="PeGu TV"/></p>
            ...
            <Row>
              <Col>
                <div className="det">
                  ...
                  <br/>
                  <p className="tmdb-logo"><img className="" src="https://www.themoviedb.org/assets/2/v4/logos/v2/blue_short-8e7b30f73a4020692ccca9c88bafe5dcb6f8a62a4c6bc55cd9ba82bb2cd95f6c.svg" alt="PeGuTV"/></p>
            ...
            <Row>
              <Col md={{span:"8"}}>
                <div className="form-control-contact">
                  ...
                  <form action="https://formspree.io/f/mlezpweb"
  method="POST">
                    <Row>
                      <Col md={6}>
              ...
              <Col md="4">
                <div className="card det card-dev">
                  <img src="https://avatars.githubusercontent.com/u/85025275?v=4" className="avatar" width="100%" alt="Pegu TV"/>
                  <div className="card-body">
                    <h4>About the developer</h4>
                    <p>Hey, Im Thulina Perera. Im a developer and a footballer based in Kelaniya,Sri Lanka </p>
                    <p className="socials">
                      
                      <a href="https://t.me/endham" target="_blank" rel="noreferrer"><FaTelegram/></a>
                      <a href="mailto:endhamfc@gmail.com" target="_blank" rel="noreferrer"><FaEnvelope/></a>
                      <a href="https://wa.me/qr/Q4VXDDGTICEDC1" target="_blank" rel="noreferrer"><FaWhatsapp/></a>
                      <a href="https://github.com/mhflk" target="_blank" rel="noreferrer"><FaGithub/></a>
                      <a href="https://thulina2004.netlify.app/" target="_blank" rel="noreferrer"><FaGlobe/></a>
                    </p>
                  </div>
                </div>
              </Col>
